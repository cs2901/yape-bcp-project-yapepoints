...
public class DevelopersAdapter extends RecyclerView.Adapter<DevelopersAdapter.ViewHolder> {
    ...
    // se hace lista de desarrolladores (cupones)
    ...
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {// para cada nueva vista
    ...
    @Override
    public void onBindViewHolder(ViewHolder holder, final int position) {//para llenar la vista
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  {//esta si es la carta
